...
BASE_INGREDIENTS = [
    ...
    'кипяток', 'кипяченая вода', 'холодная кипяченая вода', 'кипяченая вода',
    'минеральная вода', 'газированная вода',
    # Соль и ее виды
    'соль', 'соль морская', 'соль крупная', 'соль чесночная',
    'соль с травами', 'соль гималайская розовая', 'соль адыгейская',
    'соль каменная', 'соль сванская',
    # Перец черный, белый, красный и их формы
    'перец черный молотый', 'перец черный свежемолотый', 'перец черный горошком',
    'перец белый молотый', 'перец белый горошком', 'перец белый свежемолотый',
    'перец красный молотый', 'перец красный жгучий', 'перец красный хлопьями',
    'перец острый красный', 'перец острый', 'перец чили молотый',
    'перец чили хлопьями', 'перец чили сушеный', 'перец кайенский молотый',
    'перец острый зеленый', 'перец чили зеленый', 'перец чили красный',
    'перец чипотле', 'перец красный', 'перец стручковый красный',
    'порошок чили', 'перец лимонный', 'перец розовый молотый',
    'перец розовый горошком', 'перец душистый', 'перец душистый горошком',
    'перец душистый молотый',
    # Смеси перцев
    'смесь перцев', 'смесь молотых перцев', 'смесь перцев молотых',
    'смесь перцев свежемолотая', 'смесь перцев горошком',
    'смесь острых перцев', 'смесь четырех перцев',
    # Паприка и ее виды
    'паприка', 'паприка молотая', 'паприка сладкая', 'паприка копченая',
    'паприка острая', 'сушеная паприка',
    # Чеснок и лук сушеные
    'чеснок сушеный', 'чеснок сушеный молотый', 'порошок чесночный',
    'сухой чеснок', 'чесночный порошок', 'сублимированный чеснок',
    'сушеный чеснок', 'лук сушеный молотый', 'сушеный лук', 'луковый порошок',
    # Лавровый лист
    'лавровый лист', 'лавровый лист молотый',
    # Итальянские и прованские травы
    'итальянские травы', 'прованские травы', 'приправа “прованские травы”',
    'сушеные прованские травы',
    # Карри и куркума
    'карри', 'паста карри', 'куркума', 'куркума молотая',
    # Кориандр и зира
    'кориандр', 'кориандр молотый', 'молотый кориандр', 'семена кориандра',
    'зира', 'зира молотая', 'молотая зира',
    # Другие травы и специи из категории
    'тимьян', 'тимьян сушеный', 'орегано', 'орегано сушеный',
    'сухой орегано', 'базилик сушеный', 'сушеный базилик',
    'мята сушеная', 'петрушка сушеная', 'укроп сушеный',
    'розмарин сушеный', 'майоран сушеный', 'эстрагон сушеный',
    'шалфей сушеный',
    # Универсальные приправы
    'специи', 'приправы', 'сухие травы', 'смесь пряных трав',
    'смесь сухих приправ', 'приправа для курицы', 'приправа для мяса',
    'приправа для рыбы', 'приправа для супа', 'специи для курицы',
    'специи для мяса', 'специи для рыбы', 'специи для супа',
    'хмели-сунели', 'приправа овощная', 'приправа итальянская',
    'средиземноморские травы', 'смесь трав',
    # Специальные смеси
    'смесь для плова', 'приправа для плова', 'приправа для корейской моркови',
    'специи для корейской моркови', 'аджика', 'аджика острая',
    'гарам масала', 'специи гарам масала', 'смесь тандури масала',
    'каджунская смесь специй', 'уцхо-сунели',
    'масло растительное', 'масло подсолнечное', 'масло оливковое',
    'масло сливочное', 'масло для жарки', 'масло топленое',
    'масло рафинированное', 'масло нерафинированное',
    'масло оливковое extra virgin', 'масло сливочное 82%',
    'масло сливочное соленое', 'масло сливочное несоленое',
    'топленое масло', 'сливочное масло', 'маргарин', 'маргарин сливочный',
    'жир', 'кулинарный жир', 'смалец', 'жир свиной', 'сало',
    'растительный жир', 'масло кукурузное', 'масло рапсовое',
    'масло виноградной косточки', 'масло кунжутное', 'масло кокосовое',
    'масло арахисовое', 'масло тыквенное', 'масло горчичное',
    'масло миндальное', 'масло авокадо', 'масло канолы',
    'масло пальмовое', 'оливковое масло', 'подсолнечное масло',
    'растительное масло', 'жир для выпечки', 'топленый жир',
    'гусиный жир', 'курдючный жир',
    'соус соевый', 'соус соевый светлый', 'соус соевый острый',
    'уксус', 'уксус столовый', 'уксус яблочный', 'уксус бальзамический',
    'уксус винный', 'уксус винный белый', 'уксус винный красный',
    'уксус рисовый', 'уксус 9%', 'уксус 6%', 'уксус 3%',
    'уксусная кислота', 'уксусная эссенция',
    'горчица', 'горчица дижонская', 'горчица зернистая',
    'горчица острая', 'горчица сладкая', 'горчица столовая',
    'горчица русская', 'горчичный порошок', 'сухая горчица',
    'кетчуп', 'кетчуп острый', 'кетчуп томатный',
    'майонез', 'майонез домашний', 'майонез оливковый',
    # Другие распространенные соусы, которые часто считаются "базовыми"
    'томатная паста', 'кетчуп чили', 'соус табаско',
    'соус чили', 'соус чили сладкий', 'соус барбекю',
    'соус терияки', 'соус устричный', 'соус рыбный',
    'соус вустерский', 'аджика', 'васаби', 'хрен', 'хрен столовый',
    'ткемали', 'соус ткемали',
    'сахар', 'сахар белый', 'сахар коричневый', 'сахар тростниковый',
    'сахар пальмовый', 'сахар кокосовый', 'сахар ванильный',
    'сахарная пудра', 'сахарная пудра ванильная', 'сахарный песок',
    'тростниковый сахар', 'коричневый сахар', 'мягкий коричневый сахар',
    'сахар мусковадо',
    'мед', 'мед жидкий', 'мед гречишный', 'мед светлый', 'мед акациевый',
    'патока', 'патока черная', 'кленовый сироп', 'сироп агавы',
    'сироп топинамбура', 'сироп стевии', 'стевия',
    'фруктоза', 'заменитель сахара', 'сахарозаменитель',
    'сахар для выпечки', 'сахарная пудра для глазури',
    'мука', 'мука пшеничная', 'мука высшего сорта', 'мука общего назначения',
    'мука цельнозерновая', 'мука ржаная', 'мука кукурузная',
    'мука гречневая', 'мука овсяная', 'мука нутовая', 'мука рисовая',
    'мука миндальная', 'мука кокосовая', 'мука льняная',
    'крахмал', 'крахмал картофельный', 'крахмал кукурузный',
    'кукурузный крахмал', 'крахмал тапиоковый',
    'манка', 'манная крупа', 'манка для пудинга',
    # Также часто к "базовым сыпучим" относят
    'сода', 'сода пищевая', 'сода гашеная',
    'разрыхлитель', 'пекарский порошок', 'разрыхлитель теста',
    'дрожжи', 'дрожжи сухие', 'дрожжи свежие', 'дрожжи быстродействующие',
    'сухие дрожжи', 'прессованные дрожжи',
